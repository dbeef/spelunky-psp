...
namespace Consts
{
    ...
    const int SPLASH_SCREEN_WIDTH = 21;
    const int SPLASH_SCREEN_HEIGHT = 13;

    const int ROOM_TILE_WIDTH_SPLASH_SCREEN = 21;
    const int ROOM_TILE_HEIGHT_SPLASH_SCREEN = 13;
