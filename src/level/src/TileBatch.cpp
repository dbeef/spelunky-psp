...
void TileBatch::get_neighbouring_tiles(float x, float y, MapTile *out_neighboring_tiles[9]) const
{
    ...
    right_middle = x_tiles + 1 <= 31 && map_tiles[x_tiles + 1][y_tiles]->exists ? map_tiles[x_tiles + 1][y_tiles] : nullptr;
    up_middle = y_tiles - 1 >= 0 && map_tiles[x_tiles][y_tiles - 1]->exists ? map_tiles[x_tiles][y_tiles - 1] : nullptr;
    down_middle = y_tiles + 1 <= 31 && map_tiles[x_tiles][y_tiles + 1]->exists ? map_tiles[x_tiles][y_tiles + 1] : nullptr;
    ...
    right_up = x_tiles + 1 <= 31 && y_tiles - 1 >= 0 && map_tiles[x_tiles + 1][y_tiles - 1]->exists ? map_tiles[x_tiles + 1][y_tiles - 1] : nullptr;
    left_down = x_tiles - 1 >= 0 && y_tiles + 1 <= 31 && map_tiles[x_tiles - 1][y_tiles + 1]->exists ? map_tiles[x_tiles - 1][y_tiles + 1] : nullptr;
    right_down = x_tiles + 1 <= 31 && y_tiles + 1 <= 31 && map_tiles[x_tiles + 1][y_tiles + 1]->exists ? map_tiles[x_tiles + 1][y_tiles + 1] : nullptr;
