...
entt::entity prefabs::ItemCollectedParticle::create()
{
    return create(0, 0);
}

entt::entity prefabs::ItemCollectedParticle::create(float pos_x_center, float pos_y_center)
{
    ...
    quad.frame_changed<CollectiblesSpritesheetFrames>(CollectiblesSpritesheetFrames::ITEM_COLLECTED_0_FIRST);

    animation.start(static_cast<std::size_t>(CollectiblesSpritesheetFrames::ITEM_COLLECTED_0_FIRST),
