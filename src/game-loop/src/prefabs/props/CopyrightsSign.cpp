...
entt::entity prefabs::CopyrightsSign::create()
{
    return create(0, 0);
}

entt::entity prefabs::CopyrightsSign::create(float pos_x_center, float pos_y_center)
{
    ...
    QuadComponent quad(TextureType::MAIN_MENU, 16.25, 1.0);
    MeshComponent mesh;
