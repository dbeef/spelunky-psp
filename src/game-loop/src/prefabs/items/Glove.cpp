...
namespace
{
    class GloveScript : public ScriptBase
    {
    public:
...
entt::entity prefabs::Glove::create()
{
    return create(0, 0);
}

entt::entity prefabs::Glove::create(float pos_x_center, float pos_y_center)
{
    auto& registry = EntityRegistry::instance().get_registry();
    ...
    registry.emplace<ScriptingComponent>(entity, std::make_shared<GloveScript>());
