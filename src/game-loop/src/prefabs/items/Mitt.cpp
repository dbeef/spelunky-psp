...
namespace
{
    class MittScript : public ScriptBase
    {
    public:
...
entt::entity prefabs::Mitt::create()
{
    return create(0, 0);
}

entt::entity prefabs::Mitt::create(float pos_x_center, float pos_y_center)
{
    auto& registry = EntityRegistry::instance().get_registry();
    ...
    ItemComponent item(ItemType::MITT, ItemApplication::PASSIVE, ItemSlot::OTHER);
    ...
    registry.emplace<ScriptingComponent>(entity, std::make_shared<MittScript>());
