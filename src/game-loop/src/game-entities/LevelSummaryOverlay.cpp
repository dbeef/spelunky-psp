...
{
    {
        ...
        _texts.level_completed.set_text(get_level_completed_msg(stats->get_current_level()));
...

    {
        ...
        _texts.time.set_text(get_time_msg(stats->get_time_playing_current_level_ms(), stats->get_time_playing_total_ms()));
