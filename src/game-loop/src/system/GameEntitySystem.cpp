...
GameEntitySystem::GameEntitySystem() : _entities(std::make_shared<GameEntities>())
{
...
void GameEntitySystem::update(World* world, std::uint32_t delta_t)
{
    for (const auto& entity : *_entities)
    {
        entity->update(world, delta_t);
    }
